...
export const toastNotifications = {
  ...
  success: {
    ...
    paymentSuccess: (amount: number) =>
      toast.success("Payment successful!", {
        description: `Payment of Rp ${amount.toLocaleString(
          "id-ID"
        )} has been processed.`,
        duration: 4000,
      }),
  ...
  promise: {
    ...
    updateProfile: (promise: Promise<any>) =>
      toast.promise(promise, {
    ...
    createOrder: (promise: Promise<any>) =>
      toast.promise(promise, {
