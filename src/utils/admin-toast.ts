...
export const adminToast = {
  ...
  category: {
    ...
    hasProducts: () =>
      toast.warning("Cannot delete category!", {
        description:
          "This category contains products. Remove all products first.",
        duration: 4000,
      }),
  },
  ...
  order: {
    ...
    updateStatusError: (error?: string) =>
  ...
  shipment: {
    ...
    updateStatus: (trackingNumber: string, status: string) =>
  ...
  // Lookbook Management
  lookbook: {
    create: (photoTitle: string) =>
      toast.success("Lookbook photo added!", {
        description: `${photoTitle} has been added to the lookbook.`,
        duration: 4000,
      }),

    update: (photoTitle: string) =>
      toast.success("Lookbook photo updated!", {
        description: `${photoTitle} has been updated successfully.`,
        duration: 4000,
      }),

    delete: (photoTitle: string) =>
      toast.success("Lookbook photo deleted!", {
        description: `${photoTitle} has been removed from the lookbook.`,
        duration: 4000,
      }),

    createError: (error?: string) =>
      toast.error("Failed to add lookbook photo!", {
        description: error || "Unable to add lookbook photo. Please try again.",
        duration: 4000,
      }),

    updateError: (error?: string) =>
      toast.error("Failed to update lookbook photo!", {
        description:
          error || "Unable to update lookbook photo. Please try again.",
        duration: 4000,
      }),

    deleteError: (error?: string) =>
      toast.error("Failed to delete lookbook photo!", {
        description:
          error || "Unable to delete lookbook photo. Please try again.",
        duration: 4000,
      }),

    reorder: () =>
      toast.success("Lookbook order updated!", {
        description: "The lookbook photos have been reordered successfully.",
        duration: 4000,
      }),

    reorderError: () =>
      toast.error("Failed to update lookbook order!", {
  ...
  promise: {
    product: (promise: Promise<any>, operation: string) =>
    ...
    category: (promise: Promise<any>, operation: string) =>
      toast.promise(promise, {
    ...
    deal: (promise: Promise<any>, operation: string) =>
      toast.promise(promise, {
    ...
    order: (promise: Promise<any>, operation: string) =>
      toast.promise(promise, {
    ...
    user: (promise: Promise<any>, operation: string) =>
      toast.promise(promise, {
    ...
    shipment: (promise: Promise<any>, operation: string) =>
      toast.promise(promise, {
    ...
    lookbook: (promise: Promise<any>, operation: string) =>
      toast.promise(promise, {
