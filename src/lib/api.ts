// API Configuration - set NEXT_PUBLIC_API_URL ke backend lokal (mis. http://localhost:8080/api) agar soldCount dll tersimpan
const API_BASE_URL =
...
class ApiClient {
  ...
  async updateProduct(
    id: string,
    productData: Partial<Omit<Product, "sizes" | "images">> & {
