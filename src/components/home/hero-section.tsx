  ...
  return (
    <section className="relative min-h-[400px] sm:min-h-[500px] md:min-h-[600px] lg:min-h-[700px] flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-muted/20 to-background dark:from-background dark:via-primary/5 dark:to-secondary/10 py-8 sm:py-12 md:py-16 lg:py-20">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center hero-content relative z-10">
        ...
        >
          <h1 className="font-pragmatica font-[700] tracking-[-0.02em] leading-[0.95] uppercase text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl mb-4 sm:mb-5 md:mb-6 bg-gradient-to-r from-foreground to-muted-foreground dark:from-foreground dark:to-primary bg-clip-text text-transparent">
            Discover Premium Quality
          </h1>

          <p className="font-pragmatica tracking-[0.02em] text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground dark:text-muted-foreground mb-5 sm:mb-6 md:mb-8 max-w-2xl mx-auto leading-relaxed px-4 sm:px-0">
          ...
          {/* Trust Indicators */}
          <div className="mt-8 sm:mt-10 md:mt-12 flex flex-wrap justify-center items-center gap-4 sm:gap-6 md:gap-8 text-sm sm:text-base md:text-lg text-muted-foreground dark:text-muted-foreground">
