...
export const ProductDetail: React.FC<ProductDetailProps> = ({ productId }) => {
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="space-y-4 sm:space-y-6 lg:space-y-8">
          ...
          {product.sizes && product.sizes.length > 0 && (
            <div>
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-5 gap-2 sm:gap-3 lg:gap-4 mb-4 sm:mb-6">
                {product.sizes.map((sizeItem) => (
                  <button
                    key={sizeItem.id}
                    onClick={() => setSelectedSize(sizeItem.size)}
                    className={`p-3 sm:p-4 lg:p-5 border rounded-lg text-center transition-colors ${
              ...
              {selectedSize && (
                <p className="text-sm sm:text-base lg:text-lg text-green-600 mb-2">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 lg:space-x-6">
            <Label htmlFor="quantity" className="text-sm sm:text-base lg:text-lg">
              Quantity:
            </Label>
            <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-3">
              <Button
                ...
                disabled={quantity <= 1}
                className="h-8 w-8 sm:h-10 sm:w-10 lg:h-12 lg:w-12 p-0"
              >
              ...
              <Input
                ...
                className="w-16 sm:w-20 lg:w-24 text-center text-sm sm:text-base lg:text-lg h-8 sm:h-10 lg:h-12"
                min="1"
                max={product.stock}
              />
              <Button
          ...
          <div className="space-y-3 sm:space-y-4 lg:space-y-6">
            ...
            <Button
              ...
              disabled={product.stock === 0}
              className="w-full text-sm sm:text-base lg:text-lg h-10 sm:h-12 lg:h-14"
              size="lg"
            >
          ...
          {/* Product Features */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 lg:gap-6 pt-4 sm:pt-6 lg:pt-8 border-t">
            <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4">
              <Truck className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-500" />
              <span className="text-sm sm:text-base lg:text-lg">Free Shipping</span>
            </div>
            <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4">
              <Shield className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-green-500" />
              <span className="text-sm sm:text-base lg:text-lg">Secure Payment</span>
            </div>
            <div className="flex items-center space-x-2 sm:space-x-3 lg:space-x-4">
              <Package className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-purple-500" />
              <span className="text-sm sm:text-base lg:text-lg">Quality Guarantee</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
          ...
          <Button
            ...
            className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-sm sm:text-base lg:text-lg h-10 sm:h-12 lg:h-14"
          >
            <MessageSquare className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 mr-2" />
